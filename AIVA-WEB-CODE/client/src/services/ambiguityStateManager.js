/*=================================================================
 * Project: AIVA-WEB
 * File: ambiguityStateManager.js
 * Author: AI Enhancement Module
 * Date Created: January 9, 2026
 *=================================================================
 * Description:
 * Manages ambiguous state in conversations where the assistant
 * asks clarifying questions. Implements explicit confirmation
 * dialog pattern to prevent parsing errors on ambiguous inputs.
 * 
 * Key Concept: LOCKED STATE
 * When a question has multiple options, the conversation enters
 * a LOCKED state where:
 * 1. Only explicit option selections are accepted
 * 2. Natural language inputs like "yes/no" are rejected
 * 3. User must click a dialog button or use keyboard navigation
 * 4. The state prevents ambiguous interpretation
 *=================================================================
 * Copyright (c) 2024 Mohitraj Jadeja. All rights reserved.
 *=================================================================*/

/**
 * Ambiguity State Types
 */
