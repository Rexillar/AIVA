 ...
 *=================================================================
 * Description:
 * Floating chatbot component for AI assistant
 *=================================================================
  ...
  useEffect(() => {
    if (isOpen && chat.length === 0) {
      setChat([
        {
          role: "assistant",
          content: `Hi! I'm your universal AI assistant. I can help you with:

✅ **Tasks** - Create, list, update, delete tasks
💡 **Habits** - Track and manage habits
🗂️ **Workspaces** - Organize your work
📝 **Notes** - Create and search notes
🔔 **Notifications** - View and manage alerts
⏰ **Reminders** - Set and manage reminders

Try asking me things like:
• "Create a task for reviewing PR"
• "Show my overdue tasks"
• "Create workspace for Project X"
