 ...
 *=================================================================
 * Description:
 * Explicit confirmation dialog for handling ambiguous user inputs
 * Implements: Explicit Confirmation Dialog + Locked State
 * Prevents parsing ambiguous answers like "yes" when multiple options are presented.
